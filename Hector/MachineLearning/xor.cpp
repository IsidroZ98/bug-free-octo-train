...
int main()
{
	...
	for(size_t i =0 ;i<2;++i){
		for(size_t j =0 ; j<2;++j){
			std::cout<<i<<" | "<<j<<" = "<<std::to_string(sigmoidf(m.or_w1*i + m.or_w2*j + m.or_b))<<std::endl;
		}
	}
	std::cout<<"----------------------------\nNAND neuron:\n";
	...
	for(size_t i =0 ;i<2;++i){
		for(size_t j =0 ; j<2;++j){
			std::cout<<"~("<<i<<" & "<<j<<")"<<" = "<<std::to_string(sigmoidf(m.nand_w1*i + m.nand_w2*j + m.nand_b))<<std::endl;
		}
	}
	std::cout<<"----------------------------\nAND neuron:\n";
	...
	for(size_t i =0 ;i<2;++i){
		for(size_t j =0 ; j<2;++j){
			std::cout<<i<<" & "<<j<<" = "<<std::to_string(sigmoidf(m.and_w1*i + m.and_w2*j + m.and_b))<<std::endl;
		}
	}
